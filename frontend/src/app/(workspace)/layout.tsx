...
// Each item corresponds to a screen or screen group
const navigation = [
  { name: 'Dashboard', href: '/workspace', icon: '📊', screen: '2' },
  { name: 'Quotations', href: '/workspace/quotations', icon: '📝', screen: '3-4' },
  { name: 'Approvals', href: '/workspace/approvals', icon: '✅', screen: '5-6' },
  ...
  { name: 'Deal Health', href: '/workspace/deal-health', icon: '💊', screen: '14' },
  { name: 'Reports', href: '/workspace/reports', icon: '📈', screen: '15' },
];

// Secondary navigation for catalog/product management
const catalogNav = [
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <aside className="fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200">
        ...
        <nav className="p-4 space-y-1">
          {/* Main navigation - matches Excalidraw screens */}
          <div className="mb-2">
